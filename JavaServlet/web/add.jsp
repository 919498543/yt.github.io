...
<div align="center">
    <div class="container" style="..." align="center">
        <form class="form-horizontal" action="/servletAdd" method="post" id="myform">
            ...
            <div class="form-group" align="center">
                ...
                <div class="col-sm-5" align="center">
                    <input type="text" align="center" class="form-control" name="name"  placeholder="姓名">
                </div>
            </div>
            <div class="form-group" align="center">
                <label for="inputPassword3" class="col-sm-4 control-label">年龄：</label>
                <div class="col-sm-5" align="center">
                    <input type="text" align="center" onkeyup="value=value.replace(/\D/g,'')" onafterpaste="value=value.replace(/\D/g,'')" class="form-control" name="age"  placeholder="年龄">
                </div>
            </div>
            <div class="form-group" align="center">
